    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Learning with AI</Text>
            </View>
            ...
            <View style={styles.content}>
                ...
                <Text style={styles.description}>
                    Master AI-powered learning tools and techniques. All our courses include video tutorials,
                    hands-on projects, and community support. Learn at your own pace!
                </Text>
                ...
                {filteredCourses.length === 0 ? (
                    ...
                    filteredCourses.map((course) => (
                        ...
                        >
                            ...
                            <Text style={styles.enrollButton}>→ View Course</Text>
                        </TouchableOpacity>
                    ))
                )}
            </View>
